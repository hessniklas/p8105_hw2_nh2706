...
The data used above shows the trash collected by water-wheel vessels that removes trash from Harbors. Two sets of data were used - `Mr. Trash Wheel` and `Professor Trash Wheel` - and, after a number of cleaning steps, combined into one large dataset. After conducting the aforementioned operations, the following information can be found:
